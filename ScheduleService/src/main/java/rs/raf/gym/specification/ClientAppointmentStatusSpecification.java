...
public class ClientAppointmentStatusSpecification extends BaseSpecification<ClientAppointmentStatus> {
    ...
    public ClientAppointmentStatusSpecification(String name) {
    ...
    private void addNameSpecification(String name) {
        ...
        specifications.add((root, query, criteriaBuilder) -> criteriaBuilder.equal(root.get(ClientAppointmentStatus.name()),
                                                                                   name));
    }
